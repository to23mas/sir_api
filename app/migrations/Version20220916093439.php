 ...
 */
final class Version20220916093439 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ingredients ADD CONSTRAINT FK_4B60114FCD42CE46 FOREIGN KEY (foreign_id) REFERENCES recipes (rec_id) ON DELETE CASCADE');
    }
